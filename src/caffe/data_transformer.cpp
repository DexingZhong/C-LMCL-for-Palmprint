  ...
  if (do_smooth) {
    ...
    switch (smooth_type) {
        ...
        case 2:
            ...
            break;
        case 3:
            cv::GaussianBlur(cv_img, smoothArr, cv::Size(smooth_param, smooth_param), 0);
            maskArr = cv_img - smoothArr;
            cv_img += maskArr;
            break;
        case 4:
            cv::blur(cv_img, smoothArr, cv::Size(smooth_param, smooth_param));
            maskArr = cv_img - smoothArr;
            cv_img += maskArr;
            break;
        case 5:
            cv::medianBlur(cv_img, smoothArr, smooth_param);
            maskArr = cv_img - smoothArr;
            cv_img += maskArr;
            break;
        default:
